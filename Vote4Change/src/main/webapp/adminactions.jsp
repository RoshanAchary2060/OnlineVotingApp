    ...
    <body>
        <%
            ...
            out.println("<div class='sticky'><div class='candidate'>VOTE FOR CHANGE</div><br>"
                    ...
                    + "<div class='container'>"
                    + "<div id='dv1' onclick='manageuser()'><img src='images/muser.png' height='255px' width='255px'/><br>"
                    + "<h3>Manage User</h3></div>"
                    + "<div id='dv1' onclick='managecandidate()'><img src='images/ManageCandLists.jpg' height='255px' width='255px'/><br>"
                    + "<h3>Manage Candidate</h3></div>"
                    + "<div id='dv1' onclick='electionresult()'><img src='images/resultgraph.jpg' height='255px' width='255px'/><br>"
